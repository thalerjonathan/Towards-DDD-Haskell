...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aT, request.L, true);
		} catch (e) {
...
var $author$project$Main$Account = F2(
	function (a, b) {
		return {$: 2, a: a, b: b};
	});
var $author$project$Main$AllCustomers = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
...
var $author$project$Page$Account$AccountLoaded = function (a) {
	return {$: 0, a: a};
};
var $author$project$Page$Account$Loading = F3(
	function (a, b, c) {
		return {$: 0, a: a, b: b, c: c};
	});
var $author$project$Api$Account = F2(
	function (details, txLines) {
		return {Z: details, a6: txLines};
	});
var $author$project$Api$AccountDetails = F3(
	function (iban, balance, accountType) {
		return {aE: accountType, aI: balance, ae: iban};
	});
...
var $author$project$Api$TXLine = F5(
	function (iban, name, reference, amount, time) {
		return {aG: amount, ae: iban, ah: name, aY: reference, a2: time};
	});
var $elm$json$Json$Decode$map5 = _Json_map5;
var $author$project$Api$txLineDecoder = A6(
	$elm$json$Json$Decode$map5,
	$author$project$Api$TXLine,
	A2($elm$json$Json$Decode$field, 'txLineIban', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'txLineName', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'txLineReference', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'txLineAmount', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'txLineTime', $elm$json$Json$Decode$string));
var $author$project$Api$accountDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Api$Account,
	A2($elm$json$Json$Decode$field, 'accountDetails', $author$project$Api$accountDetailsDecoder),
	A2(
		$elm$json$Json$Decode$field,
		'accountTXLines',
		$elm$json$Json$Decode$list($author$project$Api$txLineDecoder)));
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aF: false, aJ: r.aJ, K: r.K, aO: r.aO, aT: r.aT, a3: r.a3, a5: r.a5, L: r.L}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{aJ: $elm$http$Http$emptyBody, K: r.K, aO: _List_Nil, aT: 'GET', a3: $elm$core$Maybe$Nothing, a5: $elm$core$Maybe$Nothing, L: r.L});
};
var $author$project$Page$Account$init = F3(
	function (iban, cid, cname) {
		return _Utils_Tuple2(
			A3($author$project$Page$Account$Loading, iban, cid, cname),
			$elm$http$Http$get(
				{
					K: A2($elm$http$Http$expectJson, $author$project$Page$Account$AccountLoaded, $author$project$Api$accountDecoder),
					L: '/rest/account/' + iban
				}));
	});
var $author$project$Page$AllCustomers$AllCustomersLoaded = $elm$core$Basics$identity;
var $author$project$Page$AllCustomers$Loading = {$: 0};
var $author$project$Api$CustomerDetails = F2(
	function (id, name) {
		return {aQ: id, ah: name};
	});
	...
	$elm$http$Http$request(
		{
			...
			L: 'http://localhost:8080/rest/customer/all/'
		}));
var $author$project$Page$Customer$CustomerLoaded = $elm$core$Basics$identity;
var $author$project$Page$Customer$Loading = function (a) {
	return {$: 0, a: a};
};
var $author$project$Api$Customer = F2(
	function (details, accountDetails) {
		return {aD: accountDetails, Z: details};
	});
...
var $author$project$Page$Customer$init = function (cid) {
	return _Utils_Tuple2(
		...
		$elm$http$Http$get(
			{
				K: A2($elm$http$Http$expectJson, $elm$core$Basics$identity, $author$project$Api$customerDecoder),
				L: '/rest/customer/' + cid
			}));
};
var $author$project$Main$keyFromModel = function (m) {
	switch (m.$) {
		case 0:
			var k = m.a;
			return k;
...
var $author$project$Main$changeRouteTo = F2(
	function (maybeRoute, model) {
		var key = $author$project$Main$keyFromModel(model);
		if (maybeRoute.$ === 1) {
			return _Utils_Tuple2(
			...
			switch (maybeRoute.a.$) {
				case 0:
					...
					return A4(
						...
						$author$project$Main$AllCustomers(key),
						$author$project$Main$GotAllCustomersMsg,
						model,
						$author$project$Page$AllCustomers$init);
				case 2:
					var cid = maybeRoute.a.a;
					return A4(
						$author$project$Main$updateWith,
						$author$project$Main$Customer(key),
				...
				default:
					...
					var iban = _v2.a;
					var customerId = _v2.b;
					var customerName = _v2.c;
					return A4(
						$author$project$Main$updateWith,
						$author$project$Main$Account(key),
						$author$project$Main$GotAccountMsg,
						model,
						A3($author$project$Page$Account$init, iban, customerId, customerName));
			}
		}
	});
...
var $author$project$Route$Account = F3(
	function (a, b, c) {
		return {$: 1, a: a, b: b, c: c};
	});
var $author$project$Route$AllCustomers = {$: 0};
...
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		return A2(
			...
			$author$project$Main$Loading(key));
	});
...
var $author$project$Page$Account$DepositReply = function (a) {
	return {$: 3, a: a};
};
var $author$project$Page$Account$Failure = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
var $author$project$Page$Account$Loaded = function (a) {
	return {$: 2, a: a};
};
var $author$project$Page$Account$TransferReply = function (a) {
	return {$: 11, a: a};
};
var $author$project$Page$Account$WithdrawReply = function (a) {
	return {$: 6, a: a};
};
...
var $author$project$Api$commandResponseDecoder = A2(
	$toastal$either$Either$Decode$either,
	A2($elm$json$Json$Decode$field, 'Left', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'Right', $author$project$Api$txLineDecoder));
var $author$project$Page$Utils$errorToString = function (e) {
	switch (e.$) {
		case 0:
			var url = e.a;
...
var $author$project$Page$Account$mkInitLoadedState = F3(
	function (a, cid, cname) {
		return {a: a, M: cid, N: cname, w: 0, z: 0, A: '', B: '', D: 0};
	});
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{aJ: r.aJ, K: r.K, aO: _List_Nil, aT: 'POST', a3: $elm$core$Maybe$Nothing, a5: $elm$core$Maybe$Nothing, L: r.L});
};
var $elm$core$String$toFloat = _String_toFloat;
var $author$project$Page$Account$updateAccountWithNewTX = F2(
	function (_v0, tx) {
		var details = _v0.Z;
		var txLines = _v0.a6;
		var txUpd = A2($elm$core$List$cons, tx, txLines);
		var detailsUpd = _Utils_update(
			details,
			{aI: details.aI + tx.aG});
		return {Z: detailsUpd, a6: txUpd};
	});
				...
				case 0:
					if (!_v0.a.$) {
						...
						if (!result.$) {
							var a = result.a;
							return _Utils_Tuple2(
								$author$project$Page$Account$Loaded(
									A3($author$project$Page$Account$mkInitLoadedState, a, cid, cname)),
								$elm$core$Platform$Cmd$none);
						} else {
							var err = result.a;
							return _Utils_Tuple2(
								A2(
									$author$project$Page$Account$Failure,
									iban,
									$author$project$Page$Utils$errorToString(err)),
								$elm$core$Platform$Cmd$none);
						}
					} else {
						break _v0$12;
						...
						case 2:
							...
							return _Utils_Tuple2(
								...
								$elm$http$Http$post(
									{
										aJ: $elm$http$Http$emptyBody,
										K: A2($elm$http$Http$expectJson, $author$project$Page$Account$DepositReply, $author$project$Api$commandResponseDecoder),
										L: '/rest/account/' + (s.a.Z.ae + ('/deposit/' + $elm$core$String$fromFloat(s.w)))
									}));
						case 3:
							var result = _v0.a.a;
							var s = _v0.b.a;
							if (!result.$) {
								...
								if (!resp.$) {
									var err = resp.a;
									return _Utils_Tuple2(
										A2($author$project$Page$Account$Failure, s.a.Z.ae, err),
										$elm$core$Platform$Cmd$none);
								} else {
									var tx = resp.a;
									var accUpd = A2($author$project$Page$Account$updateAccountWithNewTX, s.a, tx);
									return _Utils_Tuple2(
										$author$project$Page$Account$Loaded(
											_Utils_update(
												s,
						...
						case 5:
							...
							return _Utils_Tuple2(
								...
								$elm$http$Http$post(
									{
										aJ: $elm$http$Http$emptyBody,
										K: A2($elm$http$Http$expectJson, $author$project$Page$Account$WithdrawReply, $author$project$Api$commandResponseDecoder),
										L: '/rest/account/' + (s.a.Z.ae + ('/withdraw/' + $elm$core$String$fromFloat(s.D)))
									}));
						case 6:
							var result = _v0.a.a;
							var s = _v0.b.a;
						...
						case 10:
							...
							return _Utils_Tuple2(
								...
								$elm$http$Http$post(
									{
										aJ: $elm$http$Http$emptyBody,
										K: A2($elm$http$Http$expectJson, $author$project$Page$Account$TransferReply, $author$project$Api$commandResponseDecoder),
										L: '/rest/account/' + (s.a.Z.ae + ('/transfer/' + (s.A + ('/' + ($elm$core$String$fromFloat(s.z) + ('/' + s.B))))))
									}));
						case 11:
							var result = _v0.a.a;
							var s = _v0.b.a;
...
var $author$project$Page$Account$Deposit = {$: 2};
var $author$project$Page$Account$DepositAmountUpdated = function (a) {
	return {$: 1, a: a};
};
var $author$project$Page$Account$Transfer = {$: 10};
var $author$project$Page$Account$TransferAmountUpdated = function (a) {
	return {$: 8, a: a};
};
var $author$project$Page$Account$TransferIbanUpdated = function (a) {
	return {$: 7, a: a};
};
var $author$project$Page$Account$TransferReferenceUpdated = function (a) {
	return {$: 9, a: a};
};
var $author$project$Page$Account$Withdraw = {$: 5};
var $author$project$Page$Account$WithdrawAmountUpdated = function (a) {
	return {$: 4, a: a};
};
		...
		case 0:
			...
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Loading account ' + (iban + '...'))
						]))
				]);
		case 1:
			var iban = model.a;
			...
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Error in account ' + (iban + (': \'' + (err + '\''))))
						]))
				]);
		default:
			var s = model.a;
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(s.a.Z.ae + (' (' + (s.a.Z.aE + ')')))
						])),
					A2(
					$elm$html$Html$h3,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text(
							'Balance: ' + $elm$core$String$fromFloat(s.a.Z.aI))
						])),
					A2(
					$elm$html$Html$a,
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$href('/spa/customer/' + s.M)
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick($author$project$Page$Account$Deposit),
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick($author$project$Page$Account$Withdraw),
									$elm$html$Html$Attributes$class('btn btn-primary')
								]),
							_List_fromArray(
								[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick($author$project$Page$Account$Transfer),
									$elm$html$Html$Attributes$class('btn btn-primary')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('Transfer')
								]))
						])),
					A2($elm$html$Html$hr, _List_Nil, _List_Nil),
					A2(
							...
							A2(
								...
								function (tx) {
									return A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('list-group-item rounded-1')
											]),
										_List_fromArray(
											[
												A2(
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$text(
																$elm$core$String$fromFloat(tx.aG))
															]))
													])),
												A2(
												$elm$html$Html$p,
							...
							return A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$href('/spa/customer/' + c.aQ)
											]),
										_List_fromArray(
											[
			...
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('btn btn-outline-primary'),
							$elm$html$Html$Attributes$href('/spa/')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Back')
							...
							return A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$href('/spa/account/' + (acc.ae + ('/' + (c.Z.aQ + ('/' + c.Z.ah)))))
											]),
										_List_fromArray(
											[
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{aS: $author$project$Main$init, aU: $author$project$Main$ChangedUrl, aV: $author$project$Main$ClickedLink, a1: $author$project$Main$subscriptions, a7: $author$project$Main$update, a8: $author$project$Main$view});
